...
No Real+Synthetic results are reported for \sepa{}, because its completed factorial protocol evaluates standalone synthetic datasets (\tstr{}) only. \dacpf{}, in contrast, is explicitly an augmentation experiment and is labelled Real+Synthetic throughout. Missing AUPRC, calibrated-probability metrics, formal membership-inference results, and external validation are not imputed or estimated; their absence is reported as a limitation (Section~\ref{sec:limitations}) rather than filled in.
